...
describe CouchbaseOrm::Types::Encrypted do
    ...
    describe "#serialize" do
        it "returns nil for a nil value" do
            expect(CouchbaseOrm::Types::Encrypted.new.serialize(nil)).to be_nil
        end

        it "returns the value unchanged otherwise (wrapping happens in Encrypt#encode_encrypted_attributes)" do
            expect(CouchbaseOrm::Types::Encrypted.new.serialize(base64_secret)).to eq(base64_secret)
        end
    end
